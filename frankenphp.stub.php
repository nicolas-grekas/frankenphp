 ...
 * worker that isn't already running, then blocks until every one has
 * published its vars (set_vars) or the shared deadline expires. Timeout
 * is in seconds.
 *
 * @param string|string[] $name
 */
function frankenphp_ensure_background_worker(string|array $name, float $timeout = 30.0): void {}

 ...
 * a fresh stream over the same underlying socket. The worker counts as ready,
 * and its startup as successful, once it waits on the stream (stream_select()
 * or a blocking read). Only callable from inside a background worker.
 *
 * @return resource
 */

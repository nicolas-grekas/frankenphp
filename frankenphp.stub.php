...
namespace FrankenPHP {
    ...
    final class WorkerHandle
    {
         ...
         * of the contract and tick() consumes it. A run has one stream, a
         * fresh one over the same socket once the script closed it.
         *
         * @return resource
         */
    ...
    /**
     * EXPERIMENTAL: the sender's side of a task. Constructing it sends the
    ...
    final class SentTaskHandle
    {
         ...
         * carries. Closing it abandons the task.
         *
         * @return resource
         */
        public function getStream() {}
     ...
     * WorkerHandle::receive(). Ending the run with a task open aborts it,
    ...
    final class ReceivedTaskHandle
    {
         ...
         * task, for stream_select() and feof(). Closing it completes the
         * task.
         *
         * @return resource
         */

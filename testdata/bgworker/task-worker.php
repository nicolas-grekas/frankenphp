...
// Bg worker processing tasks. fgets() on the handle returns a line per task
// sent to the worker, its content unspecified, and false on drain;
// receive_task() dequeues them, null when another thread got there first. The payload drives the
